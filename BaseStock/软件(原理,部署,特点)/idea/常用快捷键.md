...
8. Ctrl + 空格键 基本补全 Ctrl + Shift + 空格键 智能补全
9. Ctrl + Alt + T 使用模版环绕所选代码(例如try/catch)  Ctrl + Shift + Delete 解除环绕
10. Ctrl + Alt + Shift + j 选中光标处所有相同文本(同时修改用)   Alt + j 选中光标处文本  Alt + Shift + j 取消上一个
11. 
