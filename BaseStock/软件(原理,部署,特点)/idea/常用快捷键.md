...
8. **Ctrl + F12** 查看当前类结构
9. **Ctrl + /** 注释  **Ctrl+Shift+/** 文档注释
10. **Ctrl + -** 折叠代码  **Ctrl + =** 展开代码   **Ctrl + Shift + -** 折叠当前页全部代码
11. **Ctrl + 空格键** 基本补全 **Ctrl + Shift +** 空格键 智能补全     (选中时使用tab键是直接替换当前内容)
12. **Ctrl + Shift +** 回车键 语句补全
13. **Ctrl + Shift + 数字** 自定义标签行   使用**Ctrl + 数字**进行跳转指定标签行
14. **Ctrl + Alt + T** 使用模版环绕所选代码(例如try/catch)  **Ctrl + Shift + Delete** 解除环绕
15. **Ctrl + Alt + Shift + j** 选中光标处所有相同文本(同时修改用)   **Alt + j** 选中光标处文本  **Alt + Shift + j** 取消上一个
16. **Ctrl + Alt + M** 将所选代码块提取为方法
17. **Ctrl + Alt + T** 重构菜单(多选菜单提供多种服务) 
18. **Ctrl + Alt + F/R** 在文件中查找/替换  (提供是否区分大小与是否全匹配)
19. **Ctrl + D** 
